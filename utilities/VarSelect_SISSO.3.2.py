...
# Usage: prepare the SISSO.in and train.dat in working directory, and then run the VarSelect.py 
# python3 VarSelect.py (use python3 and newer versions)
...
nstep_converge = 20   # Converged if the best model unchanged after certain number of steps.   
restart = 0           # 0: start from scratch, 1: continue the unfinished job
runSISSO = 'mpirun -np 64  SISSO.3.2 > SISSO.log'  # The command to run SISSO
#############################################################################################
