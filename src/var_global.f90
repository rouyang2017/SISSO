...
integer   nsf,nvf,nprop,vfsize,ndimtype,maxcomplexity,rung,maxrung,lname,maxcomb,fs_size_DI,fs_size_L0,&
          L1_max_iter,L1_nlambda,L1_dens,desc_dim,nm_output,CV_fold,CV_repeat,iFCDI,npf_must,funit
parameter (lname=150,maxrung=20,maxcomb=10)
character vf2sf*10,opset(maxrung)*200,ptype*10,method*10,metric*10,task*4
